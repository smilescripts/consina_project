        ...
        <section class="sidebar">
         ...
         /.search form -->
          ...
          <ul class="sidebar-menu">
            <li class="header"><marquee style="height:15px;color:white"  behavior="scroll" >Online System Accounting Consina</marquee></li>
          ...
          $modul = $db->fetch_custom('select * from sys_modul where tampil=? and id not in(55,56,50,51,49,52,53,54,57) order by urutan asc',array('tampil'=>'Y'));
