<?php error_reporting(0);?>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                               <h1 class="headingtable"><span>General Journal</span></h1>
...
<script type="text/javascript" src="jquery.js"></script>
	...
	<div class="post">
		<div class="entry">
			...
			<form action="<?=base_index();?>jurnal-umum" method="post" name="postform">
			  <table width="435" border="0" class="table table-bordered">
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="text" name="tanggal_transaksi" size="15" value="<?php if(empty($_POST['tanggal_transaksi'])){ echo $tanggal;}else{ echo $_POST['tanggal_transaksi']; }?>"/>
					<a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.tanggal_transaksi);return false;" ><img src="../inc/calender/calender.jpeg" alt="" name="popcal" width="34" height="29" border="0" align="absmiddle" id="popcal" /></a>				
				</td>
                </tr>
                <tr>
                  <td>Keterangan</td>
                ...
                <tr>
				  ...
				  <div id="suggest">
					   ...
					   <div class="suggestionsBox" id="suggestions" style="display: none;"> <img src="../inc/arrow.png" style="position: relative; top: -12px; left: 30px;" alt="upArrow" />
                ...
                <tr>
                  <td><input type="submit" value="Simpan" name="simpan" class="btn btn-primary btn-flat"></td>
                  <td colspan="2">&nbsp;</td>
                </tr>
              </table>
			</form>
			...
			if(isset($_POST['simpan'])){
				...
				$query=mysql_query("insert into tabel_transaksi(kode_transaksi,kode_rekening,tanggal_transaksi, jenis_transaksi, keterangan_transaksi,".$dk.",id_admin)
									values('$kode_transaksi','$kode_rekening','$tanggal_transaksi','Bukti Umum','$keterangan_transaksi','$jumlah_dk','')");
			...
			if(isset($_POST['selesai'])){
				...
				if($query){
					?><script language="javascript">document.location.href="<?=base_index();?>jurnal-umum"</script><?php
				}else{
					echo mysql_error();
				}
			...
			$query=mysql_query("select * from tabel_transaksi where kode_transaksi='$kode_transaksi' ");
			...
			<br />			
			<form action="<?=base_index();?>jurnal-umum" method="post" name="form">
				...
				<input type="submit" onClick="return confirm('Apakah Anda Yakin?')" value="Selesai" class="btn btn-primary btn-flat" name="selesai"/>
			</form>
