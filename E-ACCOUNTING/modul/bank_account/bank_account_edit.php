    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Ubah Bank Account</h3>
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/bank_account/bank_account_action.php?act=up">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
						 ...
						 <a href="<?=base_index();?>bank-account" class="btn btn-success btn-flat">Batal</a>
                        </div>
                      </div><!-- /.form-group -->
                    </form>
