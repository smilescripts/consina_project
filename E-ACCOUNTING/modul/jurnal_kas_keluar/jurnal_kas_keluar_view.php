                ...
                <section class="content-header">
                    <h1>
                        Kelola Jurnal Kas Keluar
                    </h1>
                       <ol class="breadcrumb">
                        <li><a href="<?=base_index();?>"><i class="glyphicon glyphicon-home"></i>Beranda</a></li>
                        <li><a href="<?=base_index();?>jurnal-kas-keluar">Jurnal Kas Keluar</a></li>
                        <li class="active">Daftar Jurnal Kas Keluar</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                               <h1 class="headingtable"><span>Jurnal Kas Keluar</span></h1>
	...
	<div class="post">
		<div class="entry">
			...
			<form action="<?=base_index();?>jurnal-kas-keluar" method="post" name="postform">
			  <table width="512" border="0" class="table table-bordered">
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="text" name="tanggal_transaksi" size="15" value="<?php if(empty($_POST['tanggal_transaksi'])){ echo $tanggal;}else{ echo $_POST['tanggal_transaksi']; }?>"/>
                    <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.postform.tanggal_transaksi);return false;" ><img src="../inc/calender/calender.jpeg" alt="" name="popcal" width="34" height="29" border="0" align="absmiddle" id="popcal" /></a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><hr/><input type="submit" value="Simpan" name="simpan" class="btn btn-primary btn-flat"></td>
                  <td colspan="2">&nbsp;</td>
                </tr>
              </table>
			</form>
			...
			if(isset($_POST['selesai'])){
				...
				if($query_transaksi){
					?><script language="javascript">document.location.href="<?=base_index();?>jurnal-kas-keluar"</script><?php
				}else{
					echo mysql_error();
				}
			...
			<br />			
			<form action="<?=base_index();?>jurnal-kas-keluar" method="post" name="form">
				...
				<input type="submit" onClick="return confirm('Apakah Anda Yakin?')" value="Selesai" name="selesai" class="btn btn-primary btn-flat"/>
			</form>
