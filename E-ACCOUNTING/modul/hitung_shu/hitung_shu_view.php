                ...
                <section class="content-header">
                    <h1>
                       ...
                       <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>hitung-shu">Hitung SHU</a></li>
                        <li class="active">Daftar Hitung SHU</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                             <h1 class="headingtable"><span>Hitung SHU</span></h1>
	...
	<div class="post">
	  <div class="entry">
			...
			if($cek_posting!==0){
				...
				<form action="<?=base_index();?>hitung-shu" method="post" name="postform">
				<div align="center">
				<p>&nbsp;</p><p>
				<font color="#666666">
				<input type="submit" onclick="return confirm('Apakah Anda Yakin?')" name="hitung_shu" value="Proses Hitung SHU" class="btn btn-primary btn-flat" />
				</font></p>
				</div>
				</form>
				<font color="#666666">
