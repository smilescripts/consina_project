...
<html>
  <head>
	...
	<link rel="icon" href="<?=base_admin();?><?=$profil->logo; ?>">
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
 
   <!-- special jquery jQuery 2.1.3 -->
    <script src="<?=base_admin();?>assets/plugins/jQuery/jQuery-2.1.3.min.js"></script>
	<link href="<?=base_admin();?>assets/plugins/jQuery/bootstrap-colorpicker.min.css" rel="stylesheet">
	
	<script src="<?=base_admin();?>assets/plugins/jQuery/bootstrap-colorpicker.js"></script>
 <?php
...
<!--home assets -->
     <!-- Bootstrap 3.3.2 -->
    <link href="<?=base_admin();?>assets/bootstrap/css/bootstrap.php" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
   <!--   <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />-->
    <!-- Ionicons -->
    <link href="<?=base_admin();?>assets/ionicons/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Morris chart -->
    ...
    <!-- Theme style -->
    <link href="<?=base_admin();?>assets/dist/css/AdminLTE.min.php" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="<?=base_admin();?>assets/dist/css/skins/_all-skins.min.php" rel="stylesheet" type="text/css" />
     <?php
...
<!-- list table -->
   ...
   <!--   <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />-->
	...
	<script src="<?=base_admin();?>assets/dist/js/shortcut.js" type="text/javascript"></script>
