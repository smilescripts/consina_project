...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/user/user_action.php?act=up">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="TANGGAL_TERDAFTAR" value="<?=$data_edit->TANGGAL_TERDAFTAR;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="STATUS_AKTIF" value="<?=$data_edit->STATUS_AKTIF;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="DISKON_BELANJA" class="control-label col-lg-2">DISKON_BELANJA</label>
                        <div class="col-lg-10">
                          <input type="text" name="DISKON_BELANJA" value="<?=$data_edit->DISKON_BELANJA;?>" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->

                      <input type="hidden" name="id" value="<?=$data_edit->KODE_PELANGGAN;?>">
                      <div class="form-group">
