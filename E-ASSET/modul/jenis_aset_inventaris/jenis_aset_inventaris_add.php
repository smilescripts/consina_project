                ...
                <section class="content-header">
                    <h1>
                     Jenis Aset Inventaris
                        ...
                        <li class="active">Tambah Jenis Aset Inventaris</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Tambah Jenis Aset Inventaris</h3>
                                   
                                </div>

                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/jenis_aset_inventaris/jenis_aset_inventaris_action.php?act=in">
                      <div class="form-group">
                        <label for="Nama Harta" class="control-label col-lg-2">Nama Harta</label>
                        <div class="col-lg-10">
                          <input type="text" name="nm_harta" placeholder="Nama Harta" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Keterangan" class="control-label col-lg-2">Keterangan</label>
                        <div class="col-lg-10">
                          <textarea id="editbox" name="ket" class="editbox"></textarea>
                        </div>
                      </div><!-- /.form-group -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="submit" class="btn btn-primary btn-flat" value="Simpan"> &nbsp;
						   <a href="<?=base_index();?>jenis-aset-inventaris" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i>Kembali</a>
