                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Laporan Aset</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Ubah Laporan Aset</h3>
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/laporan_aset/laporan_aset_action.php?act=up">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
						 ...
						 <a href="<?=base_index();?>laporan-aset" class="btn btn-success btn-flat">Batal</a>
                        </div>
                      </div><!-- /.form-group -->
                    </form>
