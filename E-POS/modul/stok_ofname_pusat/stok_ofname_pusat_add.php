                ...
                <section class="content-header">
                    <h1>
                     Stok Ofname Pusat
                        ...
                        <li class="active">Tambah Stok Ofname Pusat</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Tambah Stok Ofname Pusat</h3>
                                   
                                </div>

                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/stok_ofname_pusat/stok_ofname_pusat_action.php?act=in">
