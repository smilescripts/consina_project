                ...
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Laporan Retur</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Detail Laporan Retur</h3>
                   ...
                   <form class="form-horizontal">
                      <div class="form-group">
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-lg-10">
                             <a href="<?=base_index();?>laporan-retur" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i>Kembali</a>
