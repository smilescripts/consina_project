                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Stock Adjustment Outlet</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Ubah Stock Adjustment Outlet</h3>
                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/stock_adjustment_outlet/stock_adjustment_outlet_action.php?act=up">
                      <div class="form-group">
                        <label for="Tanggal" class="control-label col-lg-2">Tanggal</label>
                        <div class="col-lg-10">
                          <input type="text" id="tgl1" data-rule-date="true" name="tanggal" value="<?=$data_edit->tanggal;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
               ...
               <?php foreach ($db->fetch_all("barang_outlet") as $isi) {
               		...
               		if ($data_edit->id_barang==$isi->KODE_BARANG) {
               			echo "<option value='$isi->KODE_BARANG' selected>$isi->NAMA_BARANG</option>";
               		} else {
               		echo "<option value='$isi->KODE_BARANG'>$isi->NAMA_BARANG</option>";
               			}
               } ?>
              </select>
                        </div>
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="kurang" value="<?=$data_edit->kurang;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
						 ...
						 <a href="<?=base_index();?>stock-adjustment-outlet" class="btn btn-success btn-flat">Batal</a>
                        </div>
                      </div><!-- /.form-group -->
                    </form>
