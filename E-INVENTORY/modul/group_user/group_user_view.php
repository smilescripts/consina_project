                ...
                <section class="content">
                    <div class="row">
						...
						<div class="btnbantuan" style="margin-top:-55px;">
							<a href="<?=base_index();?>group-user/tambah" style="border-radius:20px" class="btn btn-primary btn-flat"><i class="glyphicon glyphicon-plus-sign"></i>Tambah</a>
							</div>
...
<td><?=$isi->deskripsi;?></td>
<td><a href="<?=base_index();?>group-user/detail/<?=$isi->id;?>" class="btn btn-success btn-flat"><i class="glyphicon glyphicon-eye-open"></i></a> 
<a href="<?=base_index();?>group-user/edit/<?=$isi->id;?>" class="btn btn-primary btn-flat"><i class="glyphicon glyphicon-pencil"></i></a> 
<button class="btn btn-danger btn-flat hapus" data-uri="<?=base_admin();?>modul/group_user/group_user_action.php" data-id="<?=$isi->id;?>"><i class="glyphicon glyphicon-trash"></i> </button> </td></tr>
        <?php
        $no++;
      }
      ?>
