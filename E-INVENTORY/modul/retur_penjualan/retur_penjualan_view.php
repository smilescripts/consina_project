                ...
                <section class="content-header">
                       ...
                       <ol class="breadcrumb">
                        ...
                        <li class="active">Daftar Retur Penjualan</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                               	<h1 class="headingtable"><span>Retur</span>  Penjualan</h1>
						
                                <div class="box-body table-responsive">
					<form  method="POST" class="form-horizontal foto_banyak" action="">
                      <div class="form-group">
                        <label for="NO_NOTA_PENJUALAN" class="control-label col-lg-2">No.Nota Penjualan</label>
                        <div class="col-lg-4">
                          <input type="text" name="NO_NOTA_PENJUALAN" placeholder="Masukan No.Nota Penjualan" class="form-control" > 
                        </div>
                       <input type="submit" class="btn btn-primary btn-flat" value="Cari" name="cariretur"> &nbsp;
						 
					  </div><!-- /.form-group -->
					<p style="margin-left:25px;font-size:9pt"><i>Catatan:Masukan no.nota yang tertera pada struk penjualan ke kolom no nota penjualan diatas.</i></p>
                     </form>
			...
			$cek=$db->fetch_custom("select max(NO_RETUR) as idMaks from retur_penjualan");
			...
			$data_edit=mysql_fetch_object(mysql_query("select * from penjualan where NO_NOTA_PENJUALAN='$_POST[NO_NOTA_PENJUALAN]' and OUTLET='$KODEOUTLETUSER'"));
			if($data_edit->NO_NOTA_PENJUALAN==""){
				
				echo '<script>alert("Maaf No.Faktur Tidak Ditemukan");window.location=""</script>';
			}
          ...
          <div class="row invoice-info">
            <div class="col-sm-8 invoice-col">
              ...
              <address>
                <strong></strong><br>
               No.Faktur:<?=$data_edit->NO_NOTA_PENJUALAN;?><br>
               Kasir:<?=$kasir->first_name;?><br>
               Outlet:<?=$outlet->NAMA_OUTLET;?><br>
               Pelanggan:<?=$data_edit->PELANGGAN;?><br>
			...
			<div class="col-sm-4 invoice-col">
              ...
              <address>
               ...
               Tanggal Jual:<?=$data_edit->TANGGAL;?><br>
          ...
          <div class="row">
			...
			<input type="hidden" name="NO_NOTA_PENJUALAN" value="<?=$data_edit->NO_NOTA_PENJUALAN;?>">
              ...
              <div class="table-responsive">
                <table class="table">
				  ...
				  <tr>
                    ...
                    <td><?=number_format($data_edit->DISKON_PELANGGAN);?></td>
                  </tr> 
		 ...
		 <?php 
			...
			error_reporting(0);
			mysql_query("insert into retur_penjualan values('$_POST[NO_RETUR]','$_POST[NO_NOTA_PENJUALAN]','$_POST[TANGGAL_RETUR]','$_POST[OPERATOR_KASIR]','$_POST[CATATAN]')") or die (mysql_error());
			foreach($_POST["KODE_BARANG"] as $key=>$value){
			$JUMLAH_RETUR=$_POST["JUMLAH_RETUR"][$key];
			$JUMLAH_BELI=$_POST["JUMLAH_BELI"][$key];
			mysql_query("insert into detail_retur_penjualan values(NULL,'$_POST[NO_RETUR]','$value','$JUMLAH_RETUR')") or die (mysql_error());
			}
			mysql_query("delete from detail_retur_penjualan where NO_RETUR='$_POST[NO_RETUR]' and JUMLAH_RETUR='0'");
