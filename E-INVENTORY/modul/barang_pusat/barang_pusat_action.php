...
switch ($_GET["act"]) {
	...
	$data = array("KODE_BARANG"=>$_POST["KODE_BARANG"],"BARCODE"=>$_POST["BARCODE"],"NAMA_BARANG"=>$_POST["NAMA_BARANG"],"WARNA"=>$_POST["WARNA"],"UKURAN"=>$_POST["UKURAN"],"KETERANGAN"=>$_POST["KETERANGAN"],"HARGA_MODAL"=>$_POST["HARGA_MODAL"],"HARGA_JUAL"=>$_POST["HARGA_JUAL"],"STOK"=>$_POST["STOK"],"ID_KATEGORI"=>$_POST["ID_KATEGORI"],"DISKON"=>$_POST["DISKON"],"ID_SATUAN"=>$_POST["ID_SATUAN"],);
