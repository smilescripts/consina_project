                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
							...
							?>
							<a href="<?=base_index();?>pengiriman-barang/tambah" class="btn btn-primary btn-flat"><i class="glyphicon glyphicon-plus-sign"></i>Tambah Data</a>
                            <?php
                            } 
							} 
							}
...
var dataTable = $("#pengiriman_barang_dtb").dataTable({
     ...
     $('td:eq('+indek+')', nRow).html(' <a href="<?=base_index();?>pengiriman-barang/detail/'+aData[indek]+'" alt="Detail" title="Detail" class="btn btn-success btn-flat"><i class="glyphicon glyphicon-eye-open"></i></a> <?=$edit;?> <?=$del;?>');
